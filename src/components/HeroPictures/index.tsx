...
import ImageSpiderWoman65 from "@public/spiders/spider-gwen-65.png";
...
const HeroImage: Record<string, StaticImageData> = {
  "spider-man-616": ImageSpiderMan616,
  "spider-gwen-65": ImageSpiderWoman65,
...
const HeroPictures = ({ hero }: IProps) => {
  return (
    <Image
      src={HeroImage[hero.id]}
